...
import { SidebarContainer, NavHeader, NavItemList, NavItem, Label, NavLink } from './style';
...
const Sidebar = (props) => {
    return (
        <SidebarContainer>
            ...
            <Route path="/browse">
                {({ match }) => (
                    <NavItem isActive={ match && match.url === '/browse'}>
                        <NavLink to="/browse">
                ...
                <Route path="/search">
                {({ match }) => (
                    <NavItem isActive={ match && match.url === '/search'}>
                        <NavLink to="/search">
